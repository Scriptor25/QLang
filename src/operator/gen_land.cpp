...
QLang::ValuePtr QLang::GenLAnd(const SourceLocation& where, Builder& builder, const ValuePtr& lhs, const ValuePtr& rhs)
{
    ...
    const auto value = builder.IRBuilder().CreateAnd(lhs_ir, rhs_ir);
